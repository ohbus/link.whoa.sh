...
import { ApiService, PagedUrlsResponse, CreateShortUrlRequest, CreateShortUrlResponse, UrlAnalyticsResponse, GlobalClicksResponse } from './api.service';
...
describe('ApiService', () => {
  ...
  it('should create a short URL', () => {
    ...
    const mockResponse: CreateShortUrlResponse = { originalUrl: 'https://example.com', shortUrl: 'http://localhost:8844/custom' };
  ...
  it('should get analytics for a short code', () => {
    const mockResponse: UrlAnalyticsResponse = { originalUrl: 'https://example.com', shortUrl: 'http://localhost:8844/abc', clicks: 100 };
